...
from Core_System.mcp_tools import MCPTools
...
"""
    ...
    from Core_System.spell_corrector import SpellCorrector
    ...
    from Core_System.intent_clarifier import IntentClarifier
...
if __name__ == "__main__":
    import uvicorn
    # Fix: Run from package root
    uvicorn.run("Core_System.server:app", host="0.0.0.0", port=8000, reload=True)
